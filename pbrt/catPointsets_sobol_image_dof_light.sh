...
NBDIM=5
DIM[1]="${UTKPATH}SobolIndices_2dd -x 1 -y 4" #Image Plane (2D)
DIM[2]="${UTKPATH}SobolIndices_2dd -x 2 -y 3" #Depth of Field (2D)
#Bounce 1
DIM[3]="${UTKPATH}SobolIndices_2dd -x 5 -y 7" #Light point (2D) 
