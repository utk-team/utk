...
NBDIM=5
DIM[1]="${UTKPATH}HaltonSpp_2dd --spp ${NBSPP} --dimx 11 --dimy 13" #Image Plane (2D)
DIM[2]="${UTKPATH}HaltonSpp_2dd --spp ${NBSPP} --dimx 5 --dimy 7" #Depth of Field (2D)
#Bounce 1
DIM[3]="${UTKPATH}HaltonSpp_2dd --spp ${NBSPP}" #Light point (2D) 
