...
DIM[2]="${UTKPATH}BNLDS_2dd_subset -K 4 --sobolD0 3 --sobolD1 7 --lut-in ${UTKDATAPATH}BNLDS/factorK_4/Sobol_37/allPermutsCache_Sobol+OptPerms_3_7_00000.dat" #Depth of Field (2D)
#Bounce 1
DIM[3]="${UTKPATH}BNLDS_2dd_subset -K 4 --lut-in ${UTKDATAPATH}BNLDS/factorK_4/Sobol_12/allPermutsCache_Sobol+OptPerms_1_2_00000.dat" #Light point (2D) 
DIM[4]="${UTKPATH}SobolIndices_2dd -x 4 -y 8"  #Light Scattering (2D)
