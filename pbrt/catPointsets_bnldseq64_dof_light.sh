...
#Bounce 1
DIM[3]="${UTKPATH}BNLDS_2dd --sobolD0 1 -- sobolD1 4 -K 8 --lut-in fastoptim_lut_sobol1_4_k8_lvlmax3_sampler_BNLDS_optimizer_PCF_RandomOpti_2dd.dat"  #Light point (2D) 
