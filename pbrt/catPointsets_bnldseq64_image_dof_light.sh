...
NBDIM=5
DIM[1]="${UTKPATH}BNLDS_2dd --sobolD0 1 -- sobolD1 4 -K 8 --lut-in fastoptim_lut_sobol1_4_k8_lvlmax3_sampler_BNLDS_optimizer_PCF_RandomOpti_2dd.dat" #Image Plane (2D)
DIM[2]="${UTKPATH}BNLDS_2dd --sobolD0 2 -- sobolD1 3 -K 8 --lut-in fastoptim_lut_sobol2_3_k8_lvlmax3_sampler_BNLDS_optimizer_PCF_RandomOpti_2dd.dat" #Depth of Field (2D)
#Bounce 1
DIM[3]="${UTKPATH}BNLDS_2dd --sobolD0 5 -- sobolD1 7 -K 8 --lut-in fastoptim_lut_sobol5_7_k8_lvlmax3_sampler_BNLDS_optimizer_PCF_RandomOpti_2dd.dat" #Light point (2D) 
DIM[4]="${UTKPATH}SobolIndices_2dd -x 6 -y 8"  #Light Scattering (2D)
