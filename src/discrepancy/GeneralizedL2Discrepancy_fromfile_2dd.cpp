...
int main(int argc, char** argv)
{
	...
	GeneralizedL2Discrepancy disc;
	
	initParserDiscrepancy(&parser);
	
	bool param_logValue = false;
	parser.addLongOption((char*)"log", &param_logValue, 0, assignBoolTrue, displayBool, (char*)"\tComputes the discrepancy in log values", (char*)"Log");
	...
	disc.setLogValue(param_logValue);
