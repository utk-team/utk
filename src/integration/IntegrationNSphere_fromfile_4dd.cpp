...
int main(int argc, char** argv)
{
	...
	if(param_output_func)
	{
		...
		for(int l=0; l<20; l++)
		{
			Point<3, double> pt; pt.pos()[0] = (20.0/2.0)-(double)i/20.0; pt.pos()[1] = (20.0/2.0)-(double)j/20.0; pt.pos()[2] = (20.0/2.0)-(double)k/20.0; pt.pos()[3] = (20.0/2.0)-(double)l/20.0;
			file << i << " " << j << " " << k << " " << l << " " << disc.sampleIntegrand(pt) << std::endl;
		}
