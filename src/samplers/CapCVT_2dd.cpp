...
int main(int argc, char** argv)
{
	...
	double lambda=30.0;
	parser.addLongOption((char*)"lambda", &lambda, 1, assignDouble, displayDouble, "[float]\t\t The lambda value", "Lambda");
	...
	if(lambda == 0)
		WARNING("The lambda value =0, the resulting point set will be equivalent to a CCVT point set");
