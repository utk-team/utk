...
#define GLUT_VIEWER_STEREOSCOPIC_EYE_DISTANCE 5
	...
	extern GLUT_VIEWER_API void glut_viewer_set_zoom(float scale)  ;
	extern GLUT_VIEWER_API float  glut_viewer_get_zoom() ;
	extern GLUT_VIEWER_API void glut_viewer_save_view_params(const char* filename) ;
	extern GLUT_VIEWER_API void glut_viewer_load_view_params(const char* filename) ;
