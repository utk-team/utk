...
GLboolean (APIENTRY *IsRenderbufferEXT) (GLuint);
...
void (APIENTRY *GetRenderbufferParameterivEXT) (GLenum, GLenum, GLint *);
GLboolean (APIENTRY *IsFramebufferEXT) (GLuint);
...
void (APIENTRY *FramebufferTexture1DEXT) (GLenum, GLenum, GLenum, GLuint, GLint);
void (APIENTRY *FramebufferTexture2DEXT) (GLenum, GLenum, GLenum, GLuint, GLint);
void (APIENTRY *FramebufferTexture3DEXT) (GLenum, GLenum, GLenum, GLuint, GLint, GLint);
void (APIENTRY *FramebufferRenderbufferEXT) (GLenum, GLenum, GLenum, GLuint);
void (APIENTRY *GetFramebufferAttachmentParameterivEXT) (GLenum, GLenum, GLenum, GLint *);
...
#define glIsRenderbufferEXT					(_GET_TLS_PROCTABLE()->IsRenderbufferEXT)
#define glBindRenderbufferEXT				(_GET_TLS_PROCTABLE()->BindRenderbufferEXT)
#define glDeleteRenderbuffersEXT			(_GET_TLS_PROCTABLE()->DeleteRenderbuffersEXT)
#define glGenRenderbuffersEXT				(_GET_TLS_PROCTABLE()->GenRenderbuffersEXT)
#define glRenderbufferStorageEXT			(_GET_TLS_PROCTABLE()->RenderbufferStorageEXT)
#define glGetRenderbufferParameterivEXT		(_GET_TLS_PROCTABLE()->GetRenderbufferParameterivEXT)
#define glIsFramebufferEXT					(_GET_TLS_PROCTABLE()->IsFramebufferEXT)
#define glBindFramebufferEXT				(_GET_TLS_PROCTABLE()->BindFramebufferEXT)
#define glDeleteFramebuffersEXT				(_GET_TLS_PROCTABLE()->DeleteFramebuffersEXT)
#define glGenFramebuffersEXT				(_GET_TLS_PROCTABLE()->GenFramebuffersEXT)
#define glCheckFramebufferStatusEXT			(_GET_TLS_PROCTABLE()->CheckFramebufferStatusEXT)
#define glFramebufferTexture1DEXT			(_GET_TLS_PROCTABLE()->FramebufferTexture1DEXT)
#define glFramebufferTexture2DEXT			(_GET_TLS_PROCTABLE()->FramebufferTexture2DEXT)
#define glFramebufferTexture3DEXT			(_GET_TLS_PROCTABLE()->FramebufferTexture3DEXT)
#define glFramebufferRenderbufferEXT		(_GET_TLS_PROCTABLE()->FramebufferRenderbufferEXT)
#define glGetFramebufferAttachmentParameterivEXT	(_GET_TLS_PROCTABLE()->GetFramebufferAttachmentParameterivEXT)
#define glGenerateMipmapEXT					(_GET_TLS_PROCTABLE()->GenerateMipmapEXT)
#define glDrawBuffersARB                         (_GET_TLS_PROCTABLE()->DrawBuffersARB)
...
{
	GEEX_API extern _GLextensionProcs _extensionProcs;
