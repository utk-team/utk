...
#include <stdlib.h>
  ...
  #include <GL/glx.h>
  #include "glprocs.h"
  #define wglGetProcAddress(x) glXGetProcAddressARB((unsigned char*)x)
#endif
...
static GLboolean APIENTRY InitIsRenderbufferEXT (GLuint renderbuffer)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glIsRenderbufferEXT");
	...
	glIsRenderbufferEXT = extproc;

	return glIsRenderbufferEXT(renderbuffer);
}

static void APIENTRY InitBindRenderbufferEXT (GLenum target, GLuint renderbuffer)
{
	void *extproc;
	...
	glBindRenderbufferEXT = extproc;

	glBindRenderbufferEXT (target, renderbuffer);
}

static void APIENTRY InitDeleteRenderbuffersEXT (GLsizei n, const GLuint *renderbuffers)
{
	void *extproc;
	...
	glDeleteRenderbuffersEXT = extproc;

	glDeleteRenderbuffersEXT (n, renderbuffers);
}

static void APIENTRY InitGenRenderbuffersEXT (GLsizei n, GLuint *renderbuffers)
{
	void *extproc;
	...
	glGenRenderbuffersEXT = extproc;

	glGenRenderbuffersEXT (n, renderbuffers);
}

static void APIENTRY InitRenderbufferStorageEXT (GLenum target, GLenum internalformat, GLsizei width, GLsizei height)
{
	void *extproc;
	...
	glRenderbufferStorageEXT = extproc;

	glRenderbufferStorageEXT (target, internalformat, width, height);
}

static void APIENTRY InitGetRenderbufferParameterivEXT (GLenum target, GLenum pname, GLint *params)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glGetRenderbufferParameterivEXT");
	...
	glGetRenderbufferParameterivEXT = extproc;

	glGetRenderbufferParameterivEXT (target, pname, params);
}

static GLboolean APIENTRY InitIsFramebufferEXT (GLuint framebuffer)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glIsFramebufferEXT");
	...
	glIsFramebufferEXT = extproc;

	return glIsFramebufferEXT (framebuffer);
}

static void APIENTRY InitBindFramebufferEXT (GLenum target, GLuint framebuffer)
{
	void *extproc;
	...
	glBindFramebufferEXT = extproc;

	glBindFramebufferEXT (target, framebuffer);
}

static void APIENTRY InitDeleteFramebuffersEXT (GLsizei n, const GLuint *framebuffers)
{
	void *extproc;
	...
	glDeleteFramebuffersEXT = extproc;

	glDeleteFramebuffersEXT (n, framebuffers);
}

static void APIENTRY InitGenFramebuffersEXT (GLsizei n, GLuint *framebuffers)
{
	void *extproc;
	...
	glGenFramebuffersEXT = extproc;

	glGenFramebuffersEXT (n, framebuffers);
}

static GLenum APIENTRY InitCheckFramebufferStatusEXT (GLenum target)
{
	void *extproc;
	...
	glCheckFramebufferStatusEXT = extproc;

	return glCheckFramebufferStatusEXT (target);
}

static void APIENTRY InitFramebufferTexture1DEXT (GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glFramebufferTexture1DEXT");
	...
	glFramebufferTexture1DEXT = extproc;

	glFramebufferTexture1DEXT (target, attachment, textarget, texture, level);
}

static void APIENTRY InitFramebufferTexture2DEXT (GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level)
{
	void *extproc;
	...
	glFramebufferTexture2DEXT = extproc;

	glFramebufferTexture2DEXT (target, attachment,  textarget, texture, level);
}

static void APIENTRY InitFramebufferTexture3DEXT (GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glFramebufferTexture3DEXT");
	...
	glFramebufferTexture3DEXT = extproc;

	glFramebufferTexture3DEXT (target, attachment, textarget, texture, level, zoffset);
}

static void APIENTRY InitFramebufferRenderbufferEXT (GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer)
{
	void *extproc;
	...
	glFramebufferRenderbufferEXT = extproc;

	glFramebufferRenderbufferEXT (target, attachment, renderbuffertarget, renderbuffer);
}

static void APIENTRY InitGetFramebufferAttachmentParameterivEXT (GLenum target, GLenum attachment, GLenum pname, GLint *params)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glGetFramebufferAttachmentParameterivEXT");
	...
	glGetFramebufferAttachmentParameterivEXT = extproc;

	glGetFramebufferAttachmentParameterivEXT (target, attachment, pname, params);
}

static void APIENTRY InitGenerateMipmapEXT (GLenum target)
{
	void *extproc;
...
static void APIENTRY InitDrawBuffersARB (GLsizei n, const GLenum *bufs)
{
	...
	extproc = (void *) wglGetProcAddress("glDrawBuffersARB");
...
#ifdef WIN32
_GLextensionProcs __declspec(dllexport) _extensionProcs = {
#else
