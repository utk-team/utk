...
/* 
 * [Bruno] gluBuild3DMipmaps is missing in
 ...
 * the GLU lib shipped with Windows.
 * This file extracts the missing functions
 * and dependencies from SGI OpenGL sample
 * implementation.
 */

/* [Bruno] defs to include these functions in Geex sourcecode */
...
/* [Bruno] GLU_INVALID_OPERATION is also undefined under Windows */
#ifndef GLU_INVALID_OPERATION
#define GLU_INVALID_OPERATION GLU_INVALID_ENUM
#endif
...
static GLboolean isLegalInternalFormat(GLenum internalFormat)
{
   switch (internalFormat) {
	 ...
	 else if (1) /* [Bruno]: does not have (gluCheckExtension("GL_EXT_texture",glGetString(GL_EXTENSIONS))) */
