...
// Bruno: replaced glh with OpenGL SDK (much cleaner),
// and added GLX wrappers
...
WRAP_GL_FUNC(
    GLXFBConfigSGIX*, glXChooseFBConfigSGIX,(Display *p1, int p2, int *p3, int *p4), (p1,p2,p3,p4)
) ;

WRAP_GL_FUNC(
    GLXPbufferSGIX, glXCreateGLXPbufferSGIX, 
    (Display *p1, GLXFBConfigSGIX p2, unsigned int p3, unsigned int p4, int *p5), (p1,p2,p3,p4,p5)
) ;

WRAP_GL_FUNC(
    GLXContext, glXCreateContextWithConfigSGIX,
    (Display *p1, GLXFBConfigSGIX p2, int p3, GLXContext p4, Bool p5), (p1,p2,p3,p4,p5)
) ;

WRAP_GL_FUNC(
    int, glXQueryGLXPbufferSGIX, (Display *p1, GLXPbufferSGIX p2, int p3, unsigned int * p4), (p1,p2,p3,p4)
) ;

WRAP_GL_PROC(
    glXDestroyGLXPbufferSGIX, (Display *p1, GLXPbufferSGIX p2), (p1,p2)
) ;
#endif
