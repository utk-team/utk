...
// Last modified:	16/03/09 (Version 1.1.ts)
	...
	double				eps)			// the error bound
{
  s_kFRSearchParams params;
	params.ANNkdFRDim = dim;					// copy arguments to static equivs
	params.ANNkdFRQ = q;
	...
	params.ANNkdFRPointMK = new ANNmin_k(k);	// create set for closest k points
	...
	delete params.ANNkdFRPointMK;				// deallocate closest point set
