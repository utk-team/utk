...
namespace Geex {
    ...
    namespace MatrixUtil {
		...
		double GEEX_API det(const Matrix<double, 3> &m);
		void GEEX_API sym_eig_values(const Matrix<double, 3> &mat, double eig_values[3]);
		void GEEX_API sym_eig_vectors(const Matrix<double, 3> &m, /*const*/ double eigval[3], Matrix<double, 3> &eigvec );
		Matrix<double, 3> GEEX_API spd_pow(const Matrix<double, 3> &m, double power);
         ...
         */
        void GEEX_API semi_definite_symmetric_eigen(
