...
#include <Geex/mathematics/principal_axes.h>
...
//_________________________________________________________
    ...
    void PrincipalAxes3d::point(const vec3& p, double weight) {
...
//_________________________________________________________
    ...
    void PrincipalAxes2d::end_points() {
        ...
        if(nb_points_ < 3) {
            ...
            axis_[0] = vec2(eigen_vectors[0], eigen_vectors[1]) ;
            axis_[1] = vec2(eigen_vectors[2], eigen_vectors[3]) ;
    ...
    void PrincipalAxes2d::point(const vec2& p, double weight) {
