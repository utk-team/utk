#include "SamplerVictor2D2D_06022017.hpp"
...
int main(int argc, char** argv)
{
	...
	parser.addLongOption((char*)"sobolD3", &param_sobol_ids[3], 1, assignUInt, displayUInt, (char*)"<uint=4> the sobol indices for dimension 3", (char*)"Sobol Id 3");
