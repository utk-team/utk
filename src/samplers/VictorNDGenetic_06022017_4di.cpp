...
int main(int argc, char** argv)
{
	...
	parser.addLongOption((char*)"sobolD3", &param_sobol_ids[3], 1, assignUInt, displayUInt, (char*)"<uint=4> the sobol indices for dimension 2", (char*)"Sobol Id 3");
	...
	if(param_level != 0)
	{
		param_nbsamples = pow(K, 4*param_level);
	}
