#include "../../samplers/SamplerGeneticOwen.hpp"
...
int main(int argc, char** argv)
{
	...
	int param_nbiter = 1000;
	//PARSE PARAM
	initParserSampler(&parser);
	parser.addLongOption((char*)"iter", &param_nbiter, 1, assignInt, displayInt, (char*)"[int=1000] the number of iterations", (char*)"Iterations");
	//PARSING
	...
	sampler.setNbIter(param_nbiter);
