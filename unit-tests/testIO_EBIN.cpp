...
int main(int argc, char** argv)
{
	...
	{
	PointsetReader<2, unsigned int, Point<2, unsigned int> > reader;
	assert(!reader.open("iloveunicorns.ebin"));
	}
