#ifndef _CPENALTY_LINE_SEARCH_H_
#define _CPENALTY_LINE_SEARCH_H_

#include "line_search.h"

template <class Scene, class Position, class Velocity>
class CPenaltyLS : public CLineSearch<Position, Velocity>
{
protected:
    Scene* m_scene;
    double m_stiffness;
...
public:
    ...
    {
        return m_scene->compute_penalty_energy(m_stiffness);
    }
    
    void compute_gradient(std::vector<Velocity>& V) const
    {
        m_scene->compute_penalty_gradient(V, m_stiffness);
    }
